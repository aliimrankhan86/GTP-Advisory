export const vehicles = [
  {
    ...
    slug: "ai-voice-intelligence",
  },
  {
    images: [
      "/images/ai-enabler-image2.png",
      "/vehicles/IONIQ_5/02.webp",
      "/vehicles/IONIQ_5/03.webp",
      "/vehicles/IONIQ_5/04.webp",
    ],
  ...
  },
  {
    ...
    description:
      "Turn live data into foresight. Our Predictive Analytics models identify trends, surface insights, and guide smarter, faster decisions across every business function.",
    range: "95% Accuracy",
    top_speed: "Real-Time",
    mph: "Instant",
